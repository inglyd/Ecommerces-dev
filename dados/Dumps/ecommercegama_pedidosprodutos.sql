...
CREATE TABLE `pedidosprodutos` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `pedidoid` FOREIGN KEY (`id`) REFERENCES `pedidos` (`id`),
  CONSTRAINT `produtoid` FOREIGN KEY (`id`) REFERENCES `produtos` (`id`)
...
INSERT INTO `pedidosprodutos` VALUES (1,'ADAPTADOR BLUETOOH USB RECEPTOR DE AUDIO P2',5,10,2,1,1),(2,'CAMERA DE SEGURANCA XIAOMI',36,36,1,2,2);
...
-- Dump completed on 2021-05-23 19:25:36
