...
for (posicao = 0; posicao < listaProdutos.length; posicao++) {
    ...
    console.log("A soma de todos os produtos é " + qtdTotalDeProdutos);
}
...
// Quantidade total de itens em destaque (somatória das quantidades dos itens marcados como "emDestaque : sim").
  ...
  for (posicao = 0; posicao < listaProdutos.length; posicao++) {
      if (listaProdutos[posicao].emDestaque == "sim") {
          qtdTotalEmDestaque = qtdTotalEmDestaque + listaProdutos[posicao].qtdEstoque;
             }
      console.log("A quantidade total de itens em detaque é " + qtdTotalEmDestaque); 
 }
...
for (posicao = 0; posicao < listaProdutos.length; posicao++) {
    if (listaProdutos[posicao].disponivel == "sim") {
        qtdTotalItensDisponiveis = qtdTotalItensDisponiveis + listaProdutos[posicao].qtdEstoque;
             }
    console.log("A quantidade total de itens disponíveis é " + qtdTotalItensDisponiveis); 
 }
 ...
 for (posicao = 0; posicao < listaProdutos.length; posicao++) {
     qtdTotalDeValores = qtdTotalDeValores + listaProdutos[posicao].qtdEstoque * listaProdutos[posicao].preco;
     console.log("O valor total do inventário da empresa é R$" + qtdTotalDeValores);
 }
...
// Valor do ticket médio dos produtos da empresa (basicamente o valor total do inventário dividido pelo número de itens)
    ...
    for (pos = 0; pos < listaProdutos.length; pos++) {
        ...
        inventario = inventario + (listaProdutos[pos].preco * listaProdutos[pos].qtdEstoque)
        ticketMedio = inventario/estoqueTotal;
    }


    console.log("O valor do ticket médio dos produtos da empresa é: " + ticketMedio);
...
let precoA = listaProdutos[0].preco
     ...
     if (precoA < listaProdutos[pos].preco){
        ...
        console.log("O produto mais caro da loja: " + produtoMaisCaro.descricao + " preço: " + precoA + " departamento: " + produtoMaisCaro.departamento.nomeDepto);
        }
    }    
...
let precoB = listaProdutos[0].preco
     ...
     if (precoB > listaProdutos[pos].preco){
        ...
        console.log("O produto mais barato da loja: " + produtoMaisBarato.descricao + " preço: " + precoB + " departamento: " + produtoMaisBarato.departamento.nomeDepto);
        }
    }      
